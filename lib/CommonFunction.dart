...
class CommonFunction {
  static const passphrase = "8c10%\$#f9be0b053082";

  static showSnackBar(String msg, int duration, BuildContext context) {
  ...
  static String decrypt(String token) {
    return decryptAESCryptoJS(token);
  }
  ...
  static decryptAESCryptoJS(String encrypted) {
    try {
      Uint8List encryptedBytesWithSalt = convert.base64.decode(encrypted);
      ...
      final decrypted =
          encrypter.decrypt64(convert.base64.encode(encryptedBytes), iv: iv);
      return decrypted;
    } catch (error) {
      throw error;
    }
